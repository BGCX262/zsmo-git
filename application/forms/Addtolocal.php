...
class Application_Form_Addtolocal extends Zend_Form
{

    public function init()
    {
        $this->setDisableLoadDefaultDecorators(true);
        $this->setName('addtolocal')->setAttrib('class','form-horizontal')->setAttrib('enctype', 'multipart/form-data');
// * * * * * * * * DATOS PRIMERA COLUMNA
        ...
        foreach ($filaDestinatario->getDestinatarioPorNombre("Bodega Principal") as $destinatario) :
        ...
        $ctr_fecha_salida->setAttrib('placeholder',date('H:i:s d/m/Y'))->setLabel('Fecha Salida:');
        $ctr_fecha_salida->setAttrib('class', 'disabled')->setAttrib('readonly','readonly');
        ...
        $ctr_nombre->addMultiOption( 'Interno', 'Interno' );
...
// * * * * * * * DATOS SEGUNDA COLUMNA
        ...
        foreach ($filaDestinatario2->getPorTipoDestinatario("INTERNO") as $destinatario2) :
...
// * * * * * * * DATOS TERCERA COLUMNA
        ...
        $ctr_fecha_llegada->setAttrib('class', 'disabled')->setAttrib('readonly','readonly');
